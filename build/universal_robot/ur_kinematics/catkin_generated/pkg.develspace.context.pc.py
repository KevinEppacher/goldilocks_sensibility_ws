...
PROJECT_PKG_CONFIG_INCLUDE_DIRS = "/catkin_ws/src/universal_robot/ur_kinematics/include;/usr/include".split(';') if "/catkin_ws/src/universal_robot/ur_kinematics/include;/usr/include" != "" else []
